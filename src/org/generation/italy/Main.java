...
public class Main {
	...
	public static void main(String[] args) {
		...
		Inserimento prodotto: consente di inserire i dati di un nuovo prodotto al negozio. Ogni prodotto è caratterizzato da:
		...
		se la quantità disponibile è sufficiente, il prodotto si aggiunge al "carrello della spesa" applicando eventuali sconti 
		...
		do 
		{
			...
			System.out.println("Scegli la quantità");
